...
import ir.zarjame.haftrang.Adapters.InternetPackagesAdapter_RTL;
import ir.zarjame.haftrang.Models.Responses.Response_Internet_FinalPackage;
import ir.zarjame.haftrang.R;


public class InternetPackageFragment_RTL extends Fragment {
    ...
    public InternetPackageFragment_RTL() {
    }

    public static InternetPackageFragment_RTL newInstance(List<Response_Internet_FinalPackage> packages) {

        InternetPackageFragment_RTL fragment = new InternetPackageFragment_RTL();
    ...
    void populateRecycler(List<Response_Internet_FinalPackage> packages) {
        ...
        InternetPackagesAdapter_RTL adapter = new InternetPackagesAdapter_RTL(packages, getActivity(), new InternetPackagesAdapter_RTL.OnItemClickListener() {
            @Override
