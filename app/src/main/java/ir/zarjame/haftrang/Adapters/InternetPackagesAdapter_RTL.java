...
public class InternetPackagesAdapter_RTL extends RecyclerView.Adapter<InternetPackagesAdapter_RTL.MyViewHolder> {
    ...
    public InternetPackagesAdapter_RTL(List<Response_Internet_FinalPackage> categoriesList, Context context, OnItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_internetpackage_rtl, viewGroup, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Response_Internet_FinalPackage item, final InternetPackagesAdapter_RTL.OnItemClickListener listener) {
