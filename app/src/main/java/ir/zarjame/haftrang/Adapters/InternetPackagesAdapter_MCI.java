...
public class InternetPackagesAdapter_MCI extends RecyclerView.Adapter<InternetPackagesAdapter_MCI.MyViewHolder> {
    ...
    public InternetPackagesAdapter_MCI(List<Response_Internet_FinalPackage> categoriesList, Context context, OnItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_internetpackage_mci, viewGroup, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Response_Internet_FinalPackage item, final InternetPackagesAdapter_MCI.OnItemClickListener listener) {
