...
import ir.chichand.chichand.Adapters.Adapter_FlightCities;
...
public class FlightSelectCityDialog extends Dialog {
    ...
    ArrayList<Response_FlightCity> cities = new ArrayList<>();
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Adapter_FlightCities adapter = new Adapter_FlightCities(cities, context, new Adapter_FlightCities.OnItemClickListener() {
            @Override
            public void onItemClick(Response_FlightCity city, int position) {
                ...
                cities.addAll(PublicVariables.allFlightCities);
                FlightSelectCityDialog.this.dismiss();
            }
    ...
    public interface selectCityInterface {
        ...
        void onCitySelected(Response_FlightCity selectedcity);

    }


    public FlightSelectCityDialog(Context context, ArrayList<Response_FlightCity> cities, FlightSelectCityDialog.selectCityInterface listener) {
        super(context);
